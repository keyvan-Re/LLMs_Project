...
def generate_prompt_with_history(text, history, tokenizer, max_length=2048):
    ...
    prompt = "One of the most powerful AI characters, such as Siliconfriend, is going to be the first of its kind The user-friendly AI is able to create a human: active, user-assistant application Installing Assistant: Also, Assistant is available in a wide range of applications that can be used to create a Markdown application.\
 Assistant user, user-friendly user, user-friendly user interface:\n Human: Search!\Assistant: !"
